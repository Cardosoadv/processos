                                ...
                                <div class="mt-3">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php if ($pager->getTotal()>1): ?>
                                            <?= $pager->getTotal() ?> receitas encontradas.
                                        <?php else: ?>
                                            <?= $pager->getTotal() ?> receita encontrada.
                                        <?php endif; ?>
                                        </div>
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php foreach ($pagtoReceitas as $pagtoReceita): ?>
                                                    <tr>
                                                        <td><?= esc($pagtoReceita['receita']) ?></td>
                                                        <td><?= date('d/m/Y', strtotime($pagtoReceita['pagamento_receita_dt'])) ?></td>
                                                        <td><?= 'R$ ' . number_format($pagtoReceita['valor'], 2, ',', '.') ?></td>
                                                        <td>
                                                            <a href="<?= base_url('financeiro/pagamentoReceitas/editar/' . $pagtoReceita['id_pgto_receita']) ?>"
                                                                class="btn btn-sm btn-primary">
                                                                Editar
                                                            </a>
                                                            <a href="<?= base_url('financeiro/pagamentoReceitas/excluir/' . $pagtoReceita['id_pgto_receita']) ?>"
