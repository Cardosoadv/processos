                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="container">
                                <div class="d-flex justify-content-end mb-3">
                                    <a href="<?= base_url('fornecedores/novo/') ?>"
                                            ...
                                            <tbody>
                                                <?php foreach ($fornecedores as $fornecedor): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url('fornecedores/editar/' . $fornecedor['id_fornecedor']) ?>"
                                                                class="btn btn-sm btn-primary">
                                                                Editar
                                                            </a>
                                                            <a href="<?= base_url('fornecedores/excluir/' . $fornecedor['id_fornecedor']) ?>"
                                                                class="btn btn-sm btn-danger">
                                                                Excluir
                                                            </a>
                                                            <a href="<?= base_url('processos/processosdofornecedor/' . $fornecedor['id_fornecedor']) ?>"
